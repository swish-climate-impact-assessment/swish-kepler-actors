...
{
	public class CountOfPreviousDaysAdapter2: IOperation
	{
		...
		public string Run(OperationArguments splitArguments)
		{
			...
			string dateVariableName = splitArguments.String(ArgumentParser.DefaultArgumentPrefix + "dateVariable", true);
